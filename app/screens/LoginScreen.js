...
const LoginScreen = ({ navigation }) => {
  ...
  const handleSignup = () => {
    ...
    fetchSignInMethodsForEmail(authInstance, email)
      .then((methods) => {
        if (methods.length > 0) {
          ...
          .then((userCredential) => {
            ...
            setDoc(userRef, {
              ...
              .then(() => {
                ...
                // Show the success message and navigate back after a short delay
                setTimeout(() => {
              ...
              .catch(() => {
                showAlert("Failed to save user data. Please try again.");
              });
          })
          .catch((error) => {
  ...
  const handleAlertClose = () => {
    setRegistrationComplete(false); // Reset the flag
  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        />
        <Animated.Text
          style={[styles.appName, { opacity: logoAnimation }]}
        >
          Smoke Detector
        </Animated.Text>
      ...
      <CustomAlert
        ...
        message="Registration complete! Go to login."
